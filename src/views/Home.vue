<template>
  <div id="home">
    ...
    <div class="topBanner relative">
      <h1
        class="indexTitle lg:text-7xl text-main-500 text-6xl container m-auto xl:py-20 xl:px-60 py-20 px-10"
      >
      ...
      <div class="relative text-main-500">
        ...
        >
          <li class="flex p-8 rounded-xl" v-for="item in magic" :key="item">
            <div class="icon mr-5 text-sub-500 w-1/6 flex-shrink-0">
